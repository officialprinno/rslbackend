"""Shared ViewSet behaviour for logistics API endpoints."""
...
class LogisticsViewSetMixin:
    """Standard FMS response envelope and RBAC for logistics viewsets."""
    ...
    def get_permissions(self):
        ...
        if self.action in ("list", "retrieve", "history", "summary", "eligible_employees"):
